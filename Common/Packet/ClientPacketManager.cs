...
public class PacketManager
{
    ...
    public void Register()  
    {
      // MakePacket제너릭함수에게 어떤 패킷클래스를 생성할지(PlayerInfoReq같은) 알려준 다음, 그래서 MakePacket제너릭함수가 생성한 패킷클래스를 인자로 받고,
        ...
        _makeFunc.Add((ushort)PacketID.S_BroadcastEngerGame, MakePacket<S_BroadcastEngerGame>);
        // PlayerInfoReq에 짝이 맞는 PlayerInfoReqHandler를 담는 _handler딕셔너리
        _handler.Add((ushort)PacketID.S_BroadcastEngerGame, PacketHandler.S_BroadcastEngerGameHandler);
